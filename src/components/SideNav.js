...
import rahulCV from "../cv/Rahul_Eswar_CV.pdf";
    ...
    useEffect(() => {
        ...
        if (isSideNavOpen) {
            ...
            document
                ...
                .classList.add("side-nav-border");

            /* Animate the burger icon, horizontal rule */
            document
                .getElementById("burger-icon")
                .classList.add("burger-change");
            document.getElementById("nav-hr").style.animation =
                "hrFill 200ms ease 250ms forwards";

            /* Animate profile links to appear when nav opens */
            Array.from(document.getElementsByClassName("profile-link")).forEach(
                (element, index) => {
                    element.style.animation =
                        "itemsAppear 400ms ease " +
                        (250 + index * 100) +
                        "ms forwards";
                }
            );
            ...
            document
                .getElementById("side-nav")
                .classList.remove("side-nav-border");
            document
                .getElementById("burger-icon")
                .classList.remove("burger-change");
            document.getElementById("nav-hr").style.animation = "";
            ...
            <div id="side-nav">
                ...
                <div className="profile-link-container">
                    <a
                        ...
                        href="https://ca.linkedin.com/in/rahul-eswar?trk=pub-pbmap"
                        target="_blank"
                    ...
                    <a
                        className="profile-link"
                        href="https://twitter.com/BringMeTandoori"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                    ...
                    <a
                        className="profile-link"
                        href="https://www.rahulscorner.me"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
